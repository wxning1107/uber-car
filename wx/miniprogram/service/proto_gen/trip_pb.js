...
export const coolcar = $root.coolcar = (() => {
    ...
    coolcar.Trip = (function() {
         ...
         * @property {boolean|null} [isFromLoggedInUser] Trip isFromLoggedInUser
         */
        ...
        /**
         * Trip isFromLoggedInUser.
         * @member {boolean} isFromLoggedInUser
         * @memberof coolcar.Trip
         * @instance
         */
        Trip.prototype.isFromLoggedInUser = false;
        ...
        Trip.fromObject = function fromObject(object) {
            ...
            if (object.isFromLoggedInUser != null)
                message.isFromLoggedInUser = Boolean(object.isFromLoggedInUser);
            return message;
        };
        ...
        Trip.toObject = function toObject(message, options) {
            ...
            if (options.defaults) {
                ...
                object.isFromLoggedInUser = false;
            }
            ...
            if (message.isFromLoggedInUser != null && message.hasOwnProperty("isFromLoggedInUser"))
                object.isFromLoggedInUser = message.isFromLoggedInUser;
            return object;
        };
